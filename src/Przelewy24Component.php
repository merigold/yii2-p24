...
final class Przelewy24Component extends Component
{
    ...
    public function init()
    {
        ...
        if($this->eventHandlerClassName!=null)
        {
    ...
    public function renderFormFields()
    {
        ...
        if ($this->model->validate()) {
            foreach ($this->model->getAttributes() as $name => $value) {
                $html .= $this->renderFormInput($name, $value);
            }
        }
        else{
    ...
    public function verifyTransaction()
    {
        ...
        $result = $this->callUrl(self::ACTION_VERIFY_TRANSACTION, $params);
     ...
     * @return string
     */
    protected function renderFormInput($name, $value)
    {
        $html = '';
        if (strrpos($name, '_X') && is_array($value)) {
            $i = 1;
